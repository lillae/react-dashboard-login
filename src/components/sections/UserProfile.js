...
import {Section, Container, Button, Heading, Form, Block} from 'react-bulma-components';
         ...
         <form className='profile'>
          <Block renderAs="fieldset" disabled>
            ...
            <Form.Field>
              ...
              <Form.Control>
                <Form.Input placeholder={`${profile.address.street} ${profile.address.suite}, ${profile.address.city}, ${profile.address.zipcode} `} />
              </Form.Control>
            </Form.Field>
            <Form.Field>
          ...
          <Button size={1} onClick={() => setProfileOpen(false)} className='btn back'>Go Back</Button>
         </form>
        </Container>
      </div>
    </Section>
